...
const sendMail = async (type, lang, email, firstName, lastName, age, gender, wa, ID=1) => {
    ...
    if (type === 1) {
        ...
        if (lang === 'en') {
            ...
            options.html = emailType1('en', firstName, lastName, age, gender, email, wa)
        }

        else if (lang === 'id') {
            options.subject = `Hi, ${firstName}! Kenalan sama Kudoku yuk 😎`
            options.html = emailType1('id', firstName, lastName, age, gender, email, wa)
        }
