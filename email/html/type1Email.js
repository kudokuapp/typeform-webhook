const englishType1 = (firstName, lastName, age, gender, email, wa) => {
...
const bahasaType1 = (firstName, lastName, age, gender, email, wa) => {

    const link = `https://kudoku.typeform.com/to/U9a430un#firstname=${firstName}&lastname=${lastName}&age=${age}&gender=${gender}&email=${email}&wa=${wa}&index=1`
